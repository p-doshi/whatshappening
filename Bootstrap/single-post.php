...
<head>
  <meta charset="utf-8">
  <meta content="width=device-width, initial-scale=1.0" eventName="viewport">

  <title>What's Happening</title>
  <meta content="" eventName="description">
  <meta content="" eventName="keywords">
          ...
          <div class="container">
            <div class="row">
              ...
              <?php
                ...
                $urlEventName = $_GET['eventName'];
                $urlEventType = $_GET['eventtype'];
                ...
                while ($row = mysqli_fetch_assoc($eventsResult)) {
                    ...
                    $timeFormat = date_format($date, 'g:i A');

                    // If eventName is not empty and equals 'events', show all events for that eventType
                    if ($urlEventName == 'events' && $urlEventType == $event_Type) {
                            ...
                            echo '<h3><a href="single-post.php?eventNumber=' . $eventID . '">' . $eventTitle . '</a></h3>';
                    ...
                    } else  if ($urlEventName == $eventTitle) {
                            // Extracting the first character of the description
                            $var1 = substr($eventDesc, 0, 1);
                            // Extracting the rest of the description
                            $var2 = substr($eventDesc, 1, strlen($eventDesc));
                            //Multiple echo statements to print html code.
                            echo '<div class="single-post">';
                            echo '<div class="post-meta"><span class="date">' . $event_Type . '</span> <span class="mx-1">&bullet;</span> <span>DATE: ' . $dateFormat . ' TIME: ' . $timeFormat . '</span></div>';
                            echo '<br>';
                            echo '<h1 class="mb-5">' . $eventTitle . '</h1>';
                            ...
                            <div class="tab-pane fade" id="pills-trending" role="tabpanel" aria-labelledby="pills-trending-tab">
                              <?php
                                ...
                                $latest_query = "SELECT * 
                                                  ...
                                                  INNER JOIN groups g ON e.GroupID = g.GroupID
                                                  INNER JOIN eventtypes et ON e.EventTypeID = et.EventTypeID
                                                  ORDER BY e.SubmitDate DESC LIMIT 5";
